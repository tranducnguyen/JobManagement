	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="home" class="brand-logo"> <img class="logo-abbr"
				src="./images/logo-white.png" alt=""> <img
        ...
        ***********************************-->
		<div class="fixed-content-box">
			<div class="head-name">
				TaskManager <span class="close-fixed-content fa-left d-lg-none">
			...
			<div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
				<div class="tab-content" id="menu">
					<div class="tab-pane chart-sidebar fade show active"
						id="dashboard-area" role="tabpanel"></div>
							...
							<li><a class="has-arrow" href="javascript:void()"
								aria-expanded="false"> <svg
										...
										<polygon fill="#000000" opacity="0.3"
											points="5 7 5 15 19 15 19 7" />       <path
										...
										<path
											...
											fill="#000000" fill-rule="nonzero" /></g></svg> <span class="nav-text">Apps</span>
								...
								<ul aria-expanded="false">
									...
									<li><a class="has-arrow" href="javascript:void()"
										...
										<ul aria-expanded="false">
											...
											<li><a href="./ecom-product-detail.html">Product
													Details</a></li>
							...
							<li><a class="has-arrow" href="javascript:void()"
								aria-expanded="false"> <svg
										...
										<path
											...
											fill="#000000" /></g></svg> <span class="nav-text">Charts</span> <span
									class="badge badge-xs badge-light">06</span>
							</a>
								<ul aria-expanded="false">
					...
					<div class="tab-pane fade" id="components">
						<ul class="metismenu tab-nav-menu">
							...
							<li class="mega-menu mega-menu-xl"><a class="has-arrow"
								href="javascript:void()" aria-expanded="false"> <svg
										xmlns="http://www.w3.org/2000/svg"
										xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
										height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none"
										...
										<path
											...
											fill="#000000" opacity="0.3"></path></g></svg> <span class="nav-text">Bootstrap</span>
							...
							<li><a class="has-arrow ai-icon" href="javascript:void()"
								aria-expanded="false"> <svg
										...
										<path
											...
											fill="#000000" opacity="0.3"></path></g></svg> <span class="nav-text">Plugins</span>
							...
							<li><a href="widget-basic.html" class="ai-icon"
								aria-expanded="false"> <svg
										...
										<path
											...
											fill="#000000" /></g></svg> <span class="nav-text">Widget</span>
							</a></li>
						</ul>
					</div>
						...
						<ul class="metismenu tab-nav-menu">
							...
							<li><a class="has-arrow ai-icon" href="javascript:void()"
								aria-expanded="false"> <svg
										...
										<rect fill="#000000" x="6" y="15" width="5" height="2" rx="1" /></g></svg>
									<span class="nav-text">Forms</span> <span
									class="badge badge-xs badge-light">05</span>
							</a>
								<ul aria-expanded="false">
					...
					<div class="tab-pane fade" id="table">
						<ul class="metismenu tab-nav-menu">
							...
							<li><a href="table-bootstrap-basic.html"> <svg
										xmlns="http://www.w3.org/2000/svg"
										xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
										height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none"
										...
										<path
											d="M4.21611835,7.74669402 C4.30015839,7.64056877 4.40623188,7.55087574 4.5299008,7.48500698 L11.5299008,3.75665466 C11.8237589,3.60013944 12.1762411,3.60013944 12.4700992,3.75665466 L19.4700992,7.48500698 C19.5654307,7.53578262 19.6503066,7.60071528 19.7226939,7.67641889 L12.0479413,12.1074394 C11.9974761,12.1365754 11.9509488,12.1699127 11.9085461,12.2067543 C11.8661433,12.1699127 11.819616,12.1365754 11.7691509,12.1074394 L4.21611835,7.74669402 Z"
											fill="#000000" opacity="0.3"></path></g></svg> Bootstrap
							</a></li>
							<li><a href="table-datatable-basic.html"> <svg
										xmlns="http://www.w3.org/2000/svg"
										xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
										height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none"
										...
										<rect fill="#000000" opacity="0.3" x="2" y="10" width="5"
											height="10" rx="1" /></g></svg> Datatable
							</a></li>
						</ul>
					</div>
					<div class="tab-pane fade" id="extra">
						<ul class="metismenu tab-nav-menu">
							...
							<li><a href="./page-register.html"> <svg
										xmlns="http://www.w3.org/2000/svg"
										xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
										height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none"
							...
							<li><a href="./page-login.html"> <svg
										...
										<path
											...
											fill="#000000" fill-rule="nonzero"
											transform="translate(14.500000, 12.000000) rotate(-90.000000) translate(-14.500000, -12.000000) " /></g></svg>
									Login
							</a></li>
							<li><a class="has-arrow" href="javascript:void()"
								aria-expanded="false"> <svg
										...
										<rect fill="#000000" x="11" y="17" width="2" height="2" rx="1" /></g></svg>
									Error <span class="badge badge-xs badge-light">05</span>
							</a>
								<ul aria-expanded="false">
							...
							<li><a href="./page-lock-screen.html"> <svg
										xmlns="http://www.w3.org/2000/svg"
										xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
										height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none"
				...
				<div class="tab-pane chart-sidebar fade show active" role="tabpanel">
					<div class="card">
						<div class="card-header align-items-start">
							...
							<span class="btn btn-primary light sharp ml-2"> <svg
									xmlns="http://www.w3.org/2000/svg"
					...
					<div class="card bg-warning-light">
						<div class="card-header align-items-start mb-3">
							...
							<span class="btn btn-warning light sharp ml-2"> <svg
									xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" width="20px"
									height="20px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none"
						...
						<div class="card-body">
							<div class="chart-point">
								...
								<ul class="chart-point-list">
									<li><i class="fa fa-circle text-primary mr-1"></i> 40%
										Tickets</li>
									<li><i class="fa fa-circle text-success mr-1"></i> 35%
										Events</li>
									<li><i class="fa fa-circle text-warning mr-1"></i> 25%
										Other</li>
								</ul>
							</div>
						</div>
					...
					<div class="card bg-info-light">
						<div class="card-header align-items-start mb-3">
							...
							<span class="btn btn-info light sharp ml-2"> <svg
									xmlns="http://www.w3.org/2000/svg"
									xmlns:xlink="http://www.w3.org/1999/xlink" width="20px"
									height="20px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none"
									...
									<path
										...
										fill="#000000" />
									<rect fill="#000000" opacity="0.3" x="2" y="10" width="5"
										height="10" rx="1" /></g></svg>
							</span>
						</div>
						<div class="card-body">
							<p class="mb-2 d-flex">
								<img width="22" height="22" src="images/browser/icon1.png"
									class="mr-2" alt="" />Photoshop <span
									class="pull-right text-warning ml-auto">85%</span>
							</p>
							...
							<p class="mb-2 d-flex">
								<img width="22" height="22" src="images/browser/icon2.png"
									class="mr-2" alt="" />Code editor <span
									class="pull-right text-success ml-auto">90%</span>
							</p>
							<div class="progress mb-3" style="height: 4px">
							...
							<p class="mb-2 d-flex">
								<img width="22" height="22" src="images/browser/icon1.png"
									class="mr-2" alt="" />Illustrator <span
									class="pull-right text-danger ml-auto">65%</span>
							</p>
							<div class="progress" style="height: 4px">
								<div class="progress-bar bg-danger progress-animated"
									style="width: 65%; height: 4px;" role="progressbar">
									<span class="sr-only">60% Complete</span>
								</div>
							</div>
						</div>
				...
				<nav class="navbar navbar-expand">
					<div class="collapse navbar-collapse justify-content-between">
						...
						<ul class="navbar-nav header-right">
							<li class="nav-item dropdown notification_dropdown"><a
								class="nav-link bell dz-fullscreen" href="#"> <svg
									...
									<svg id="icon-minimize" width="20" height="20"
										...
										<path
											d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"></path></svg>
							</a></li>
							<li class="nav-item dropdown notification_dropdown"><a
							...
							<li class="nav-item dropdown header-profile"><a
								class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info"">
										<span>Hey, <strong>${user_Name}</strong></span> <small>Business
											Profile</small>
									</div>
							</a>
								<div class="dropdown-menu dropdown-menu-right">
							...
							<li class="nav-item right-sidebar"><a
								class="nav-link bell ai-icon" href="#"> <svg id="icon-menu"
        ...
        ***********************************-->
		<div class="deznav">
			...
			<a href="/page-login" class="logout-btn"><svg
					xmlns="http://www.w3.org/2000/svg" width="24" height="24"
					viewBox="0 0 24 24" fill="none" stroke="currentColor"
					stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="table-job">
									<table class="table job-md">
										<form:form action="" method="POST" modelAttribute="job">
											<tr>
												<td><label class="form-label"> <strong>Job
															Name</strong>
												</label></td>
												<td><form:input path="job_nm" type="text"
														placeholder="Nhập JOB name" /></td>
											</tr>
											<tr>
												<td><label class="form-label"> <strong>Job
															Description</strong>
												</label></td>
												<td><form:input path="job_ds" type="text"
														placeholder="Job description" /></td>
											</tr>
											<tr>
												<td><label class="form-label"> <strong>Job
															Details</strong>
												</label></td>
												<td><form:input path="job_dt" type="text"
														placeholder="Job details" /></td>
											</tr>
											<tr>
											...
											<form:button>
												<div class="btn-box">
													<button type="submit" formaction="/createjob">Tạo
														job mới</button>
												</div>
											</form:button>
										</form:form>
										...
										<tbody>
											<c:forEach var="jobitem" items="${jobList}">
												<tr>
													...
													<td><strong>${jobitem.job_nm}</strong></td>
													<td>${jobitem.job_ds}</td>
													<td>${jobitem.job_dt}</td>
													<td>${jobitem.no_phase}</td>
													<td>${jobitem.job_status}</td>
													<td>
														<div class="d-flex">
															<a href="/editJob/${jobitem.job_id}"
																class="btn btn-primary shadow btn-xs sharp mr-1"><i
																class="fa fa-pencil"></i></a> <a href="/deletejJob"
