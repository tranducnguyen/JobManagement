...
<title>TaskManager - Admin Dashboard</title>
<!-- Favicon icon -->
	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
			<a class="brand-logo" href="/home" > <img class="logo-abbr"
				...
				<div class="tab-content">
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						...
						<div class="card chat dz-chat-history-box d-none">
							<div class="card-header chat-list-header text-center">
								<a href="#" class="dz-chat-history-back"> <svg
							...
							<div class="card-body msg_card_body dz-scroll"
							...
							<li><a class="has-arrow" href="javascript:void()"
								aria-expanded="false"> <svg
										...
										<path
											...
											fill="#000000" fill-rule="nonzero" /></g></svg> <span class="nav-text">Tasks</span>
									<span class="badge badge-xs badge-light">10</span>
							</a>
								<ul aria-expanded="false">
									<li><a href="/job-profile">Thêm mới</a></li>
									<li><a class="has-arrow" href="javascript:void()"
							...
							<li class="nav-item dropdown header-profile"><a
								class="nav-link" href="#" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span>Hey, <strong>${user.user_Name}</strong></span> <small>Business
											Profile</small>
									</div>
							</a>
								<div class="dropdown-menu dropdown-menu-right">
        ...
        ***********************************-->
		<div class="deznav">
			...
			<a href="./controller/logout" class="logout-btn"><svg
					xmlns="http://www.w3.org/2000/svg" width="24" height="24"
					viewBox="0 0 24 24" fill="none" stroke="currentColor"
					stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
											...
											<ul class="timeline">
												<li>
													...
													class="timeline-panel text-muted" href="#"> <span>10
															minutes ago</span>
														<h6 class="mb-0">
															Youtube, a video-sharing website <strong
												...
												<tbody>
													<tr>
														...
														<td class="recent-stats d-flex align-items-center"><i
															class="fa fa-circle text-success mr-1"></i>Successful</td>
														<td><a href="#"
													...
													<tr>
														...
														<td>01 August 2020</td>
														<td class="recent-stats d-flex align-items-center"><i
															class="fa fa-circle text-danger mr-1"></i>Canceled</td>
														<td><a href="/editTask"
															class="btn btn-primary shadow btn-xs sharp mr-1"><i
																class="fa fa-pencil"></i></a> <a href="#"
															class="btn btn-danger shadow btn-xs sharp"><i
													...
													<tr>
														...
														<td>01 August 2020</td>
														<td class="recent-stats d-flex align-items-center"><i
															class="fa fa-circle text-warning mr-1"></i>Pending</td>
														<td><a href="#"
															class="btn btn-primary shadow btn-xs sharp mr-1"><i
																class="fa fa-pencil"></i></a> <a href="#"
															class="btn btn-danger shadow btn-xs sharp"><i
					...
					<div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
						<div class="card bg-primary text-white">
							<div class="card-header pb-0 border-0">
								<h4 class="card-title text-white">TASK FINISH</h4>
							</div>
							<div class="card-body">
